...
[← Why Observability?](./01-why-observability.md) | [Day 11 Index](./README.md) | [Next: The Three Pillars →](./03-three-pillars.md)
...
[Day 10 health checks](../day-10/10-health-checks.md) are **monitoring** — binary up/down.

...
[← Dashboards and Alerting](./08-dashboards-and-alerting.md) | [Day 11 Index](./README.md) | [Next: Log Aggregation →](./10-log-aggregation.md)

## Connecting Observability to SLOs

[Day 9](../day-09/11-sli-slo-and-sla.md) defined **SLI**, **SLO**, **SLA**, and **error budget**. Observability **measures** SLIs and **alerts** when budgets burn too fast.
...
Measure **SLIs** with metrics on user-visible paths. Track **error budgets** on dashboards. Alert on **burn rate**, not isolated errors. Tie observability directly to reliability commitments from Day 9.

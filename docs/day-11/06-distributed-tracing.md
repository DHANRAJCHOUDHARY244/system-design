...
[← Metrics — RED and USE](./05-metrics-red-and-use.md) | [Day 11 Index](./README.md) | [Next: Instrumentation →](./07-instrumentation.md)
...
| **Mesh sidecar** | Can auto-inject ([Day 10](../day-10/11-service-mesh-introduction.md)) |
| **Async queue** | Put trace_id in message ([Day 8](../day-08/06-message-design.md)) |
...
Ties to [Day 6 N+1](../day-06/09-n-plus-one-query-problems.md) — visible as span fan-out.

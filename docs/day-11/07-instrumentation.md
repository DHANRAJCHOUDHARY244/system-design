...
[← Distributed Tracing](./06-distributed-tracing.md) | [Day 11 Index](./README.md) | [Next: Dashboards and Alerting →](./08-dashboards-and-alerting.md)
...
1. **Health endpoints** — liveness/readiness ([Day 10](../day-10/10-health-checks.md))
...
[API Gateway](../day-10/04-api-gateway-responsibilities.md) sees all north-south traffic — instrument heavily.

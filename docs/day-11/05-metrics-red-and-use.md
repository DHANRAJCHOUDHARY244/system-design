...
[← Structured Logging](./04-structured-logging.md) | [Day 11 Index](./README.md) | [Next: Distributed Tracing →](./06-distributed-tracing.md)
...
From [Day 7](../day-07/10-distributed-cache.md): Redis hit rate, memory, evictions are USE-style metrics.

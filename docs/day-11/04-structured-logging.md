...
[← The Three Pillars](./03-three-pillars.md) | [Day 11 Index](./README.md) | [Next: Metrics — RED and USE →](./05-metrics-red-and-use.md)
...
From [Day 8 message design](../day-08/06-message-design.md): treat logs like APIs — intentional fields.

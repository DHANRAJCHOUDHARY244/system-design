...
[← Day 11 Index](./README.md) | [Next: Monitoring vs Observability →](./02-monitoring-vs-observability.md)
...
From [Day 9](../day-09/02-reliability-metrics.md): lower **MTTR** improves availability. Observability is how you achieve fast MTTR.
...
After [Day 10](../day-10/README.md), you have enough moving parts that observability is essential — not optional.

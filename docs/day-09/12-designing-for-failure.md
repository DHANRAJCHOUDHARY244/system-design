...
[← SLI, SLO, and SLA](./11-sli-slo-and-sla.md) | [Day 9 Index](./README.md)
...
8. Queue               — async buffer ([Day 8](../day-08/README.md))
...
See [Day 8: Idempotency](../day-08/10-retry-dlq-and-idempotency.md).

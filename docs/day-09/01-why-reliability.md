...
[← Day 9 Index](./README.md) | [Next: Reliability Metrics →](./02-reliability-metrics.md)
...
From [Day 4](../day-04/01-visit-website-scenario.md): DNS, load balancer, and DB can each fail independently — reliability design addresses each layer.

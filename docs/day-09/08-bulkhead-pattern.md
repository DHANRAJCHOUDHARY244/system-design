...
[← Circuit Breaker](./07-circuit-breaker.md) | [Day 9 Index](./README.md) | [Next: Graceful Degradation →](./09-graceful-degradation.md)
...
See [Day 6: Connection Pooling](../day-06/10-connection-pooling.md).
...
[Message queue](../day-08/01-why-queues.md) decouples producers from consumer capacity.

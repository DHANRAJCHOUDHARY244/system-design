...
[← Reliability Metrics](./02-reliability-metrics.md) | [Day 9 Index](./README.md) | [Next: Redundancy and HA →](./04-redundancy-and-high-availability.md)
...
Prevention: [timeouts](./05-timeouts.md), [circuit breakers](./07-circuit-breaker.md), [bulkheads](./08-bulkhead-pattern.md), [queues](../day-08/01-why-queues.md).

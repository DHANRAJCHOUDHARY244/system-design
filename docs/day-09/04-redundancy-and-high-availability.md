...
[← Failure Modes and SPOF](./03-failure-modes-and-spof.md) | [Day 9 Index](./README.md) | [Next: Timeouts →](./05-timeouts.md)
...
From [Day 5: Load Balancer](../day-05/02-load-balancer.md).
...
See [Day 6: Replication](../day-06/11-replication.md).
